<?php
	...
	$sentencia_select=$con->prepare('SELECT *FROM crud_autos ORDER BY id');
...
<body>
	...
	<div class="contenedor">
		...
		<table>
			...
			<?php foreach($resultado as $fila):?>
				<tr >
					...
					<td><a href="editar_autos.php?id=<?php echo $fila['id']; ?>"  class="btn__update" >Editar registro</a></td>
		...
		</br></br><a href="registro_autos.php" class="btn__update">Crear nuevo registro</a>
	</div>
</body>
</html>